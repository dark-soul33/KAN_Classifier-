...
from kan_modules import KANModule, KANGAMModule
...
class KAN(BaseEstimator):
    ...
    def fit(self, X, y, batch_size=512, lr=1e-3, weight_decay=1e-4, gamma=0.8):
        ...
        for epoch in tqdm(range(100)):
            ...
            train_losses.append(epoch_loss / len(loader_train))  # Average loss for the epoch
            ...
            if len(tune_losses) > 3 and tune_losses[-1] > tune_losses[-2]:
                ...
                return self,train_losses,tune_losses
...
if __name__ == '__main__':
        ...
        # Example dataset
    X, y = make_classification(n_samples=3000, n_features=8, n_informative=2, random_state=42)
    ...
    model, train_losses, validation_losses = model.fit(X, y)
